...
let Video = {
    ...
    onReady(videoId, socket){
        ...
        vidChannel.join()
            .receive("ok", resp => {
                ...
                if(ids.length > 0){ lastSeemId = Math.max(...ids) }
    ...
    renderAnnotation(msgConteiner,{user, body, at}){
        ...
        `
        msgConteiner.appendChild(template)
        msgConteiner.scrollTop = msgConteiner.scrollHeight
    },
